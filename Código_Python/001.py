...
tripl=n*3
raizq= n**(1/2)
print('O n° digitado foi {}, e seu dobro é {}, o triplo {}, e sua raiz quadrada {:.2f}...'.format(
    n,dob,tripl,raizq))
...
tab10=n*10
print('\n {} x 0 ={}\n {} x 1 ={} \n {} x2 ={}\n {} x3 ={}\n {} x4 ={} \n {} x5 ={} \n {} x6 ={} \n {} x7 ={} \n {} x8 =} \n {} x9 ={} \n {} x10 ={}'.format(
    n,tab0,n,tab1,n,tab2,n,tab3,n,tab4,n,tab5,n,tab6,n,tab7,n,tab8,n,tab9,n,tab10))
...
preco= float(
    input('Digite o valor atual do produto e ganhe 5% de_cupom na sua compra: '))
desct= preco*5
div= desct/100
desctat= preco - div
print('Voçê escolheu {}, no valor de R$ {:.2f}, e com o desconto 5% vai pagar agora R${:.2f} '.format(
    produto,preco,esctat))
